 ...
 * Class contains methods for RNA
 * Class created lended by Emanuel Mineda Carneiro
 */

public class Neural implements Cloneable {
    ...
    public Neural(Integer quantidadeEntradas, Integer quantidadeCamadaOculta, Boolean usarBias) {
    ...
    public Neural clone() {
        // Instancia rna
        Neural neural = new Neural(quantidadeEntradas, quantidadeCamadaOculta, usarBias);
        // Copia pesos entrada x camada oculta
        Double[][] pesosEntradaCamadaOcultaCopia = neural.getPesosEntradaCamadaOculta();
        for(int i = 0; i < quantidadeEntradas; i++) {
            for(int j = 0; j < quantidadeCamadaOculta; j++) {
        ...
        Double[] pesosCamadaOcultaSaidaCopia = neural.getPesosCamadaOcultaSaida();
        Double[] biasCamadaOcultaCopia = neural.getBiasCamadaOculta();
        Double[] deltaBiasCamadaOcultaCopia = neural.getDeltaBiasCamadaOculta();
        for(int i = 0; i < quantidadeCamadaOculta; i++) {
        ...
        // Copia bias da saida
        neural.setBiasSaida(biasSaida);
        neural.setDeltaBiasSaida(deltaBiasSaida);
        return neural;
    }
